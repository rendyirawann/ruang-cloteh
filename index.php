...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" type="submit" href="<?= BASE_URL ?>login.php">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="form-login">
                    <a href="<?= BASE_URL ?>login.php"><button type="submit" class="btn btn-sign-in">
                            Login
                        </button></a>
        ...
        <div class="caption">
            <div class="row">
                <div class="col-lg-12 d-none d-xl-block d-lg-block d-md-block">
                    ...
                    <a href="#about"><button type="button" class="btn btn-warning">
                            Learn More &rarr;
                        </button></a>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/bg-rc.jpg" class="d-block w-100" alt="..." />
                </div>
                <div class="carousel-item">
                    <img src="assets/img/bg2-rc.jpg" class="d-block w-100" alt="..." />
                </div>
                <div class="carousel-item">
                    <img src="assets/img/bg3-rc.jpg" class="d-block w-100" alt="..." />
                </div>
                <div class="carousel-item">
                    <img src="assets/img/bg4-rc.jpg" class="d-block w-100" alt="..." />
                </div>
                    ...
                    <div class="row" data-aos="fade-up">
                        <div class="col-lg-6">
                            <div class="info-box mb-4">
                                <i class="bx bx-map"></i>
                                <h3>Our Address</h3>
                                <p>Jl. Eka Jati No.b, Gedung Johor, Kec. Medan Johor, Kota Medan, Sumatera Utara 20144
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row text-center text-md-left">
                        ...
                        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                labore
                                et dolore magna aliqua. Ut enim minim veniam, nostrud exercitation ullamco laboris nisi
                                ut
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                            ...
                            <hr class="mb-4">
                            <p>
                                <i class="fa fa-home mr-3"></i>Jl. Eka Jati No.b, Gedung Johor, Kec. Medan Johor, Kota
                                Medan,
