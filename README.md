...
# ***IMPORTANT***
### dont forget to import db, ruang_cloteh.sql and also change db_name on folder base/koneksi.php
### dont forget to change url on folder base/base.php if your localhost port if not default, if 443 localhost/cukez but if 8080 then change it to localhost:8080/cukez
# you can view username and password on phpmyadmin
